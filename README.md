...
Analizar los distintos temas de los capítulos 3 y 4 que nos permitirán identificar las diferentes funcionalidades que tiene la ley de Ohm voltaje, resistencia, corriente mediante la realización de ejercicios para poder reforzar el conocimiento adquirido y ponerlo en práctica en la realización de circuitos eléctricos. 
    ...
    Objetivos Específicos
     ...
     -Conocer las formulas empleadas para el calculo de potencia.
     -Realizar el calculo de potencia mediante diferentes tipos de ecuaciones y datos.
     -Analizar las ecuaciones empleadas para calcular el uso de energía.
     -Comprender el uso de la energia en circuitos eléctricos.
...
![](https://github.com/mjvilla1/ImagenesTarea2/blob/main/Ejercicio41.43_2.PNG)
![](https://github.com/mjvilla1/ImagenesTarea2/blob/main/Ejercicio%2047.PNG)
...
-La potencia se puede encontrar mediante diferentes formulas ya que se tiene que analizar en base a la ley de Ohm e ir adaptando a los datos obtenidos.

-Al realizar los cálculos para la energía consumida siempre se tendra que llevar todos los valores a un mismo nivel de medicion utilizando las transformaciones de unidades para de esta manera obtener un resultado correcto.
